...
ML_predictor <- "cstemp" #options: cstemp, cs, temp, cstempall (predictors of the machine learning model: cross-temporal compact (cstemp), cross-sectional (cs), temporal (temp), cross-temporal all series in hierarchy (cstempall))
tweedie_variance_power <- 1.5 # only for xgboost and lightgbm when using the tweedie loss
